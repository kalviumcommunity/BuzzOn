...
export default {
  name: 'MainComponent',
  mounted() {
    // Add event listener to toggle language dropdown
    ...
    // Add event listener to toggle mobile navbar language menu
    const mobileNavbarLanguageButton = document.querySelector(
      '[data-collapse-toggle="navbar-language"]'
    )
    if (mobileNavbarLanguageButton) {
      mobileNavbarLanguageButton.addEventListener('click', () => {
        toggleMobileNavbarLanguage()
      })
    }
  },
}

// Define a function to toggle the language dropdown menu
...
// Define a function to toggle the mobile navbar language menu
function toggleMobileNavbarLanguage() {
  ...
  if (navbarLanguage) {
    if (navbarLanguage.classList.contains('hidden')) {
      ...
      navbarLanguage.setAttribute('aria-hidden', 'false')
    } else {
      navbarLanguage.classList.add('hidden')
      navbarLanguage.setAttribute('aria-hidden', 'true')
    }
  }
}
</script>
